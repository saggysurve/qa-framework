 ...
 */
export function getCapValue(allCaps = {}, rawCapName, defaultValue) {
 ...
 */
export function toW3cCapNames(originalCaps = {}) {
...
export async function startSession() {
    const sessionCaps = this._desiredProtocol === PROTOCOLS.W3C
        ? { capabilities: { alwaysMatch: toW3cCapNames(this.capabilities) } }
        : { desiredCapabilities: this.capabilities };
    this.log.info(`Starting ${this._desiredProtocol} Chromedriver session with capabilities: ` + JSON.stringify(sessionCaps, null, 2));
...
export function syncProtocol() {
    if (this.driverVersion) {
        ...
        if (!coercedVersion || coercedVersion.major < MIN_CD_VERSION_WITH_W3C_SUPPORT) {
            this.log.info(`The ChromeDriver v. ${this.driverVersion} does not fully support ${PROTOCOLS.W3C} protocol. ` +
    ...
    if (util.isPlainObject(chromeOptions) && chromeOptions.w3c === false) {
        this.log.info(`The ChromeDriver v. ${this.driverVersion} supports ${PROTOCOLS.W3C} protocol, ` +
