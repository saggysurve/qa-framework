 ...
 */
const getModuleRoot = util.memoize(function getModuleRoot() {
...
export const CHROMEDRIVER_CHROME_MAPPING = JSON.parse(readFileSync(path.join(getModuleRoot(), 'config', 'mapping.json'), 'utf8'));
 ...
 */
export function getMostRecentChromedriver(mapping = CHROMEDRIVER_CHROME_MAPPING) {
...
export const CD_VER = process.env.npm_config_chromedriver_version || process.env.CHROMEDRIVER_VERSION || getMostRecentChromedriver();
/**
 ...
 */
export async function getChromeVersion(adb, bundleId) {
 ...
 */
export function getChromedriverDir(osName = getOsName()) {
 ...
 */
export async function getChromedriverBinaryPath(osName = getOsName()) {
 ...
 */
export async function retrieveData(url, headers, opts = {}) {
 ...
 */
export const getOsName = util.memoize(function getOsName() {
    if (system.isWindows()) {
        return OS.WINDOWS;
    }
    if (system.isMac()) {
 ...
 */
export const getCpuType = util.memoize(function getCpuType() {
 ...
 */
export const getOsInfo = util.memoize(async function getOsInfo() {
    return {
        name: getOsName(),
 ...
 */
export function generateLogPrefix(obj, sessionId = null) {
