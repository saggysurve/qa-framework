...
export const GOOGLEAPIS_CDN = process.env.npm_config_chromedriver_cdnurl ||
    process.env.CHROMEDRIVER_CDNURL ||
    'https://chromedriver.storage.googleapis.com';
export const USER_AGENT = 'appium';
export const CHROMELABS_URL = process.env.npm_config_chromelabs_url || process.env.CHROMELABS_URL || 'https://googlechromelabs.github.io';
export const OS = {
    LINUX: 'linux',
    WINDOWS: 'win',
    MAC: 'mac',
