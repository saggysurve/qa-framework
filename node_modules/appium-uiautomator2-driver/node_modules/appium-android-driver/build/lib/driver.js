...
import { startActivity, mobileStartActivity, mobileBroadcast, mobileStartService, mobileStopService, } from './commands/intent.js';
...
import { supportedLogTypes, mobileStartLogsBroadcast, mobileStopLogsBroadcast, getLogTypes, getLog, assignBiDiLogListener, } from './commands/log.js';
...
class AndroidDriver extends BaseDriver {
    ...
    _bidiProxyUrl = null;
    _chromedriverCapsCache = new LRUCache({
        max: 20,
        updateAgeOnGet: true,
    });
    opts;
