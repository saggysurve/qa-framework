...
export declare const WEBVIEWS_DETAILS_CACHE: LRUCache<string, WebViewDetails, unknown>;
/**
 ...
 */
export declare function toDetailsCacheKey(adb: ADB, webview: string): string;
/**
 ...
 */
export declare function getWebviewDetails(adb: ADB, webview: string): WebViewDetails | undefined;
