...
export async function pullFile(remotePath) {
    if (remotePath.endsWith('/')) {
        throw new errors.InvalidArgumentError(`It is expected that remote path points to a file and not to a folder. '${remotePath}' is given instead`);
    }
...
export async function mobileDeleteFile(remotePath) {
    if (remotePath.endsWith('/')) {
        throw new errors.InvalidArgumentError(`It is expected that remote path points to a folder and not to a file. '${remotePath}' is given instead`);
    }
