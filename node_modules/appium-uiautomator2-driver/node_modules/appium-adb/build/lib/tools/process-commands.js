 ...
 */
export async function getProcessNameById(pid) {
 ...
 */
export async function getProcessIdsByName(name) {
 ...
 */
export async function killProcessesByName(name, signal = 'SIGTERM') {
    try {
