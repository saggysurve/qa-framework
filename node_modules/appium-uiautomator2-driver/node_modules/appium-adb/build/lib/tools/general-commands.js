...
export async function listFeatures() {
    this._memoizedFeatures =
        this._memoizedFeatures ||
            memoize(async () => await this.adbExec(['features']), () => this.curDeviceId);
    try {
...
export async function takeScreenshot(displayId) {
    ...
    try {
        ...
        throw new Error(`Screenshot of the ${displayDescr} failed. Code: '${err.code ?? 'unknown'}', output: '${outputStr}'`, { cause: e });
    }
    if (stdout.length === 0) {
