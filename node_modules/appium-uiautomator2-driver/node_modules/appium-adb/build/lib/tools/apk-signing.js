 ...
 */
export async function checkApkCert(appPath, opts = {}) {
...
export async function getKeystoreHash() {
    ...
    try {
        ...
        const err = e;
        throw new Error(`Cannot get the hash of '${this.keystorePath}' keystore. Original error: ${err.stderr || err.message}`, { cause: e });
    }
}
