...
export declare class ADB implements ADBOptions {
    ...
    readonly APP_INSTALL_STATE: StringRecord<import("./tools/types.js").InstallState>;
    ...
    getVersion: ((this: ADB) => Promise<import("./tools/types.js").Version>) & {
        cache: Map<unknown, Promise<import("./tools/types.js").Version>>;
    };
