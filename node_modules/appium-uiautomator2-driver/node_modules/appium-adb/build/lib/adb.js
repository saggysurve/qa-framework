...
import { DEFAULT_ADB_EXEC_TIMEOUT, cloneDeep, defaultsDeep, getSdkRootFromEnv, pick, requireSdkRoot, } from './utils/index.js';
...
export class ADB {
    ...
    constructor(opts = {}) {
        const options = defaultsDeep(opts, cloneDeep(DEFAULT_OPTS));
    ...
    clone(opts = {}) {
        ...
        const cloneOptions = defaultsDeep(opts, originalOptions);
