...
import { UiAutomator2Server } from './core.js';
...
export async function allocateSystemPort() {
...
export async function releaseSystemPort() {
    const adb = this.adb;
...
export async function allocateMjpegServerPort() {
...
export async function releaseMjpegServerPort() {
...
export async function performExecution(capsWithSessionInfo) {
    await Promise.all([
...
export async function performPostExecSetup() {
...
export async function startSession(caps) {
