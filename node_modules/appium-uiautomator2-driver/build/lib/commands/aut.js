...
export async function prepareSessionApp() {
    if (this.opts.app) {
...
export async function checkAppPresent() {
...
export async function initAUT() {
    ...
    if (this.opts.otherApps) {
        ...
        otherApps = await Promise.all(otherApps.map((app) => this.helpers.configureApp(app, [APK_EXTENSION, APKS_EXTENSION])));
...
export async function ensureAppStarts() {
    const adb = this.requireAdb();
    const appPackage = this.opts.appPackage;
